...
ax1.text(1.5,3000,r"$M_{200} < 10^{11}h^{-1}M_\odot$")
ax2.set_yticks(numpy.array([1,10,100]))
ax2.text(1.5,300,r"$2\times10^{11}h^{-1}M_\odot < M_{200} < 5\times10^{11}h^{-1}M_\odot$")
ax3.set_yticks(numpy.array([1,10,100]))
ax3.text(1.5,300,r"$M_{200} > 10^{12}h^{-1}M_\odot$")
#ax1.set_xticklabels()
